...
function lotCost(i){var p=n(i.price),l=n(i.lot);return p!=null&&l!=null&&p>0&&l>0?p*l:null;}
function decision(i){
 ...
 var cost=lotCost(i);
 return {score:Math.max(0,Math.min(100,pct)),confidence:confidence,why:why.slice(0,4),risk:risk.slice(0,3),coverage:fields,cost:cost,gmpValid:gp!=null};
}
function status(i){
