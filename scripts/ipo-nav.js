/* IPO Terminal navigation stabilizer: keeps all feature buttons visible, removes legacy Brokers, and self-loads missing feature modules. */
(function(){
'use strict';
...
var labels={'ipc-btn':'IPO Calendar','ipf-btn':'IPO Fundamentals','dna-btn':'IPO DNA','radar-btn':'IPO Radar','b-research-lens':'1-Lot Decision'};
var modules=[
 ['ipc-btn','scripts/ipo-calendar.js'],['ipf-btn','scripts/ipo-fundamentals.js'],['dna-btn','scripts/ipo-dna.js'],['radar-btn','scripts/ipo-radar.js'],['b-research-lens','scripts/ipo-analyst.js']
];
